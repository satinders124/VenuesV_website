-- Venues V: Create missing tables and RLS policies
-- Run this AFTER 20260720_fix_invited_role_and_venues_rls.sql
--
-- This is safe to run on both new and existing projects (all CREATE
-- statements use IF NOT EXISTS, all ALTER statements use IF EXISTS).
...
-- ═════════════════════════════════════════════════════════════════════════
-- PART 4: Zones RLS (venue-access based)
-- ═════════════════════════════════════════════════════════════════════════
...
-- ═════════════════════════════════════════════════════════════════════════
-- PART 5: Tasks RLS (venue-access based)
-- ═════════════════════════════════════════════════════════════════════════
...
-- ═════════════════════════════════════════════════════════════════════════
-- PART 6: Issues RLS (venue-access based)
-- ═════════════════════════════════════════════════════════════════════════
...
-- ═════════════════════════════════════════════════════════════════════════
-- PART 8: Read receipts RLS (per-user)
-- ═════════════════════════════════════════════════════════════════════════
